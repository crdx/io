...
func TestTheSimulationReachesForTheToolTheWordsName(t *testing.T) {
	tests := map[string]struct {
		...
		"a named path":        {said: "read cmd/oh/main.go", toolName: readTool, wants: map[string]string{"path": "cmd/oh/main.go"}},
		...
		"a named directory":   {said: "list cmd/oh/demo/", toolName: listTool, wants: map[string]string{"path": "cmd/oh/demo/"}},
